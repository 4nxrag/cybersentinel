...
export default function Scanner() {
  ...
  const [mode, setMode] = useState<'repo' | 'snippet'>(() => {
    return (localStorage.getItem('scannerMode') as 'repo' | 'snippet') || 'repo';
  });
  ...
  const [codeSnippet, setCodeSnippet] = useState(() => {
    return localStorage.getItem('codeSnippet') || '';
  });
  ...
  setMode(value as 'repo' | 'snippet');
  localStorage.setItem('scannerMode', value);
};
  ...
  const handleSnippetChange = (value: string) => {
    ...
    localStorage.setItem('codeSnippet', value);
  };
